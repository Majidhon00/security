...
<div class="dd2">
  ...
  <div class="dd">
    <a href="{{route('add5.edit',['add5'=>$baza1->id])}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
    <form action="{{route('add5.destroy',['add5'=>$baza1->id])}}" method="post">
      @method('DELETE')
      @csrf
...
<a href="{{route('add5.create')}}" class="btn btn-info">ADD</a>
