...
@foreach ($baza as $baza1)
      <div class="col-md-6 col-lg-4 mb-4">
        ...
        <div class="card mb-2 p-3">
            ...
            <div class="card-footer">
              ...
              <div class="dd">
                ...
                <a href="{{route('add1.edit',['add1'=>$baza1->id])}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                <form action="{{route('add1.destroy',['add1'=>$baza1->id])}}" method="POST">
                  @csrf
                  @method('DELETE')
        ...
        <div>
          <a href="{{route('add1.create')}}" class="btn btn-info">add</a>
        </div>
@endsection