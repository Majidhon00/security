        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="contact-form bg-white">
                    <div id="success"></div>
                    <form  id="contactForm" action="{{route('contactAcc.store')}}" method="POST" enctype="">
                        @csrf
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" name="name" placeholder="FISH" required="required" data-validation-required-message="Please enter your name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="tel" class="form-control" name="tel" id="subject" placeholder="Telefon" required="required"  />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                             <input type="password" class="form-control" name="password"  placeholder="Parol" required="required" data-validation-required-message="Please enter your Password" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                           
                            <button class="btn btn-primary" type="submit" id="sendMessageButton">Send </button>
                            <a href="{{route('con2.create')}}"  class="btn btn-outline-primary">log in</a>
                        </div>
                    </form>
                </div>
            </div>
